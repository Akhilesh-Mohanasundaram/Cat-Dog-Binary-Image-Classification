...
def upload():
    if request.method == 'POST' and 'photo' in request.files:
        try:
            ...
            <body style="font-family: Arial, sans-serif; background: linear-gradient(to bottom, #ffffff, #0056b3); display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0;">
                <div style="background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 10px 10px 10px rgba(0, 0, 0, 0.1); width: 250px; text-align: center;">
                    ...
                    <img src="/static/img/{filename}" alt="Uploaded Image">
                    <a href="/upload" style="background-color: #2a415a; color: #fff; padding: 10px 15px; text-decoration: none; border-radius: 5px; display: block; margin-top: 15px;">Upload Another Image</a>
                </div>
            </body>
            </html>
            """
